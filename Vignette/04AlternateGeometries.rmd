...
par(mfrow = c(1,2))
quilt.plot(equatorGrid, equatorGridValues, main="Equator Data",
...
As we can see, the rectangular fit fails badly on the data that has been rotated up to the north pole, with approximately 15 times the root mean square error of the corresponding spherical model. While the rectangular fit does perform slightly better than the spherical fit at the equator, this is an artifact of how we created the data rather than an indication that the spherical kriging is any worse at the equator than at the poles. 