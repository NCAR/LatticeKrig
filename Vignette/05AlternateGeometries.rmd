...
surface(kFit1, main="Surface Prediction Using Rectangular Kriging")
sum(kFit1$residuals^2)

kFit2 <- LatticeKrig(newLocations, dataValues)
surface(kFit2, main="Surface Prediction Using Rectangular Kriging")
...
As we can see, the rectangular fit fails badly on the data that has been rotated up to the north pole, while the corresponding spherical model matches the data best out of all four models we calculated.