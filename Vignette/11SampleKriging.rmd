...
In this example, we normalize \ttt{Phi} so that the basis functions have covariance 1 at each data point. We also print out the diagonal of the covariance matrix, $\Phi P \Phi^T$ - note that it is all ones.
```{r Calculations3New}
D <- Phi %*% P %*% t(Phi)
