...
This next plot adds a collection of simulations based on the fitted curve and the 95\% confidence envelope for the fitted curve. These simulations are easier to compute than the standard error for large data sets and so they are used to estimate the standard error of a model in LatticeKrig.
