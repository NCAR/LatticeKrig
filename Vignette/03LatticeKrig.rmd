...
#x has 50 values in [0, 1], with the endpoints 0 and 1 added explicitly
x <- as.matrix(runif(48, min=0, max=1))
trueValues <- 9*x*(1-x)^3
errors <- rnorm(50, sd = 1e-2)
y <- trueValues + errors
