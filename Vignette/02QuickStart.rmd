...
This first plot shows the 95\% confidence intervals for the individual locations, based on a collection of simulations. These simulations are easier to compute than the standard error for large data sets and so they are used to estimate the standard error of a model in LatticeKrig.
